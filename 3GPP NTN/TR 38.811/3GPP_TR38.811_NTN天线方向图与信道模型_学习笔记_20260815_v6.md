---
title: "TR 38.811 NTN 天线方向图与信道模型学习笔记 v6"
author: ""
date: "2026-08-15"
---
...
> 本笔记基于 3GPP TR 38.811 V15.4.0（Release 15）Clauses 6.3-6.10 整理，并以 TR 38.901 Clause 7.5 的几何随机信道模型（Geometry-based Stochastic Channel Model，GSCM）及 Clause 7.7 的链路级模型作为必要补充。正文先建立“通用信道生成流程”，再按“NTN 总体替换关系 → 链路预算与大尺度传播 → LSP 与局部散射 → 天线与 CDL/TDL 链路级模型”展开。
